    ...
    return (
      ...
      >
        <Form onSubmit={onUserDelete}>
          ...
          <Modal.Body>
            <p>In order to delete, please type the name of the user</p>
            <Row>
              <Col>
                <Form.Control
                  type="text"
    ...
    <div>
      <div className={styles.header}>
        <Container>
          <Row>
            <Col>
              <h3>Admin • {params.id ? 'Edit' : 'Add'} User</h3>
            </Col>
          </Row>
        </Container>
      </div>
                ...
                <Row>
                  <Form.Group as={Col} id="formGridroles">
                    <Form.Check
                      ...
                      name="roles"
                      value="developer"
                      checked={user?.roles && user?.roles.includes('developer')}
                      onChange={handleChange}
                    />
                ...
                <Row>
                  <Form.Group as={Col} id="formGridFront">
                    <Form.Check
                      ...
                      name="teams"
                      value="frontend"
                      checked={user?.teams && user?.teams.includes('frontend')}
                      onChange={handleChange}
                    />
                  </Form.Group>
                  ...
                  <Form.Group as={Col} id="formGridBackend">
                    <Form.Check
                      ...
                      name="teams"
                      value="backend"
                      checked={user?.teams && user?.teams.includes('backend')}
                      onChange={handleChange}
                    />
                  </Form.Group>
                  ...
                  <Form.Group as={Col} id="formGridDesign">
                    <Form.Check
                      ...
                      name="teams"
                      value="design"
                      checked={user?.teams && user?.teams.includes('design')}
                      onChange={handleChange}
                    />
                  </Form.Group>
                  ...
                  <Form.Group as={Col} id="formGridOthers">
                    <Form.Check
                      ...
                      name="teams"
                      value="others"
                      checked={user?.teams && user?.teams.includes('others')}
                      onChange={handleChange}
                    />
                  </Form.Group>
                </Row>
